...
class ApplicationMain {
	...
	public static function main () {
		...
		//nme.Lib.setPackage("Fabio Yuiti Goto", "PRInfiniShip", "br.com.yuiti.lab.infiniship.PRInfiniShip", "1.0.0");
	...
	private static function start ():Void {
		...
		var hasMain = false;
		var mainClass = Type.resolveClass ("br.com.yuiti.lab.infiniship.Main");
